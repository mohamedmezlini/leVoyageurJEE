...
/**
 * Servlet implementation class EnvoiContactCC
 */
@WebServlet("/EnvoiContactCC")
public class EnvoiContactCC extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EnvoiContactCC() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				this.getServletContext().getRequestDispatcher("/front/envoicontact.jsp")
