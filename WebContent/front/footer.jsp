...
<footer class="container-fluid bg-danger alert alert-danger" >
	...
	<section class="row">
		...
		<div class=" col-lg-4  col-md-4  col-xs-12 col-sm-6  ">
			...
			<p> <a href="index.php"class ="argent-color"> Accueil </a></p>
			<p> <a href="voyages.php" class ="argent-color"> Voyages  </a></p>
			<p> <a href="contact.php" class ="argent-color"> Contact </a></p>
		</div>
		<div class="col-lg-4  col-md-4  col-xs-12 col-sm-6 ">
			<div class="col-lg-10  col-md-10 col-xs-12 col-sm-10 ">
				<H2> Newsletter</H2>
				<form class="form " method="get" action="AjouterNewsletter">
					<div class="form-group">
						<input  name="mail" type="text" class="form-control" placeholder="Votre mail">
					</div>
	...
	<section class="row ">
		<div class=" col-lg-9 col-md-9  pull-right " >
			...
			Le Voyageur  (c) 2015/2016 | <a href="#"> </a> | créer par <a href="#"> LeVoyageur</a>
		</div>
	</section>
...
<script src="/LeVoyageur/js/jquery.js"></script>
<!-- Preloader -->
<!-- Bootstrap Core JavaScript -->
<script src="/LeVoyageur/js/bootstrap.min.js"></script>
